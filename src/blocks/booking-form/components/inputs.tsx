            ...
            <div className={'flex flex-col items-center space-y-2 sm:space-y-4 sm:px-16'}>
                <div className={'flex w-full flex-row justify-center space-x-4'}>
                    <div className="group flex w-full flex-col space-y-1">
                        <Label className="group-focus-within:text-primary text-chart-5 text-xs sm:text-lg">
                            {lastName.label}
                        </Label>
                        <Input
                            id={'lastName'}
                            {...props.form.register('lastName')}
                            className="placeholder:text-chart-5 focus-visible:ring-primary text-xs focus-visible:border-none sm:text-lg"
